      ...
      <div class="container">
          ...
          <div class="col-lg-4 mb-5">
            <h2 class="section-title-underline mb-5">
              <span>For Department and Students</span>
            </h2>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                ...
                <p>For Students </p>
                <p><a href="studentlogin" class="btn btn-primary px-4 rounded-0">Login</a></p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                ...
                <p>For Students </p>
                <p><a href="/student-register" class="btn btn-primary px-4 rounded-0">Register</a></p>
              </div>
            </div> 
          </div>
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                ...
                <p><a href="departmentHomepage.jsp" class="btn btn-primary px-4 rounded-0">Login</a></p>
              </div>
            </div> 
          </div>
        </div>
