...
<div class="site-mobile-menu site-navbar-target">
      ...
      <div class="site-mobile-menu-body">
        <a class="navbar-brand text-primary ml-7" href="gh.html">Home</a>
        <a class="navbar-brand text-primary" href="gh.html">Admisions</a>
        <a class="navbar-brand text-primary dropdown" href="gh.html">Courses</a>
        <div class="dropdown">
          ...
          <div class="mr-auto">
            <!-- <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                <li>
                  <a href="login-cdc-user" class="nav-link text-left">Internal Marks</a>
                </li>
                <li class="has-children">
                  <a href="about.html" class="nav-link text-left">Event</a>
                  <ul class="dropdown">
                    <li><a href="departmenteventpage">Add Event Notice</a></li>
                    <li><a href="departmentnoticeview">Show Upcoming Events</a></li>
                  </ul>
                </li>
                <li class="has-children">
                  <a href="about.html" class="nav-link text-left">Training</a>
                  <ul class="dropdown">
                    <li><a href="addtraining">Add New Training</a></li>
                    <li><a href="showalltrainings">Show All Ongoing Training</a></li>
                  </ul>
                </li>
                <li>
                  <a href="courses.html" class="nav-link text-left">Attendance</a>
                </li>
                <li>
            ...
            <div class="collapse navbar-collapse active text-left  id="navbarTogglerDemo01">
              <a class="navbar-brand text-primary text-left" href="gh.html">Hidden brand</a>
              <a class="navbar-brand text-primary text-left" href="gh.html">Hidden brand</a>
              <a class="navbar-brand text-primary text-left" href="gh.html">Hidden brand</a>
              <div class="dropdown">
 ...
 <div class="ml-auto">
              <div class="social-wrap ">
                ...
                <!-- <button class="navbar-toggler site-menu-toggle" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">
