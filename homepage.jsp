					...
					<table class="table table-striped table-bordered">
						...
						<tbody>
							<c:forEach var="user" items="${studentdetail}">
								...
								<th>${user.furtherHigherStudies}</th>
								<th>${user.hobbies}</th>
 ...
 <nav class="navbar navbar-light bg-light">
  ...
  <div class=" justify-content-end" >
    ...
    <div class="site-section">
        <div class="container-fluid">
           <div class="container-fluid text-center" id="tasksDiv">
				<h3>Mechanical Engineering BATCH (2016-20)</h3>
				<hr>
				<div class="table-responsive">
					<table class="table table-striped table-bordered">
						<thead>
 ...
 <nav class="navbar navbar-light bg-light">
  ...
  <div class=" justify-content-end" >
    ...
    <div class="site-section">
        <div class="container-fluid">
           <div class="container-fluid text-center" id="tasksDiv">
				<h3>Civil Engineering BATCH (2016-20)</h3>
				<hr>
				<div class="table-responsive">
					<table class="table table-striped table-bordered">
						<thead>
 ...
 <nav class="navbar navbar-light bg-light">
  ...
  <div class=" justify-content-end" >
    ...
    <div class="site-section">
        <div class="container-fluid">
           <div class="container-fluid text-center" id="tasksDiv">
				<h3>Computer Science and  Engineering BATCH (2016-20)</h3>
				<hr>
				<div class="table-responsive">
					<table class="table table-striped table-bordered">
						<thead>
 ...
 <nav class="navbar navbar-light bg-light">
  ...
  <div class=" justify-content-end" >
    ...
    <div class="site-section">
        <div class="container-fluid">
           <div class="container-fluid text-center" id="tasksDiv">
				<h3>Electronics and Communication BATCH (2016-20)</h3>
				<hr>
				<div class="table-responsive">
					<table class="table table-striped table-bordered">
						<thead>
